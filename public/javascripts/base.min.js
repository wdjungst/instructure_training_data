...
else var s=p/(2*Math.PI)*Math.asin(c/a);if(t<1)return-.5*(a*Math.pow(2,10*(t-=1))*Math.sin((t*d-s)*(2*Math.PI)/p))+b;return a*Math.pow(2,-10*(t-=1))*Math.sin((t*d-s)*(2*Math.PI)/p)*.5+c+b;},easeInBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;return c*(t/=d)*t*((s+1)*t-s)+b;},easeOutBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;return c*((t=t/d-1)*t*((s+1)*t+s)+1)+b;},easeInOutBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;if((t/=d/2)<1)return c/2*(t*t*(((s*=(1.525))+1)*t-s))+b;return c/2*((t-=2)*t*(((s*=(1.525))+1)*t+s)+2)+b;},easeInBounce:function(x,t,b,c,d){return c-jQuery.easing.easeOutBounce(x,d-t,0,c,d)+b;},easeOutBounce:function(x,t,b,c,d){if((t/=d)<(1/2.75)){return c*(7.5625*t*t)+b;}else if(t<(2/2.75)){return c*(7.5625*(t-=(1.5/2.75))*t+.75)+b;}else if(t<(2.5/2.75)){return c*(7.5625*(t-=(2.25/2.75))*t+.9375)+b;}else{return c*(7.5625*(t-=(2.625/2.75))*t+.984375)+b;}},easeInOutBounce:function(x,t,b,c,d){if(t<d/2)return jQuery.easing.easeInBounce(x,t*2,0,c,d)*.5+b;return jQuery.easing.easeOutBounce(x,t*2-d,0,c,d)*.5+c*.5+b;}});(function(){$(function(){var arrayOfData,colors,populate_data;arrayOfData=[];colors=['#FF3300','#FF6633','#33FF33','#0000CC','#00CCCC','#9966CC','#003300','#FF9933','#660033','#669900','#33CC33','#CC0000','#66FF66','#3399FF','#660066','#99FFFF','#99FF33','#FF6666','#00CC99','#FFFF99'];populate_data=function(users,week_num){var a,array,el,index,number,temp,_i,_len;array=users.split('~');for(index=_i=0,_len=array.length;_i<_len;index=++_i){el=array[index];a=el.split(',');number=parseFloat(a[0]);temp=[];temp.push(number);temp.push(a[1]);temp.push(colors[index]);arrayOfData.push(temp);}
arrayOfData.pop();return $(".graph-container").jqBarGraph({data:arrayOfData,legend:true,legendWidth:200,sort:'asc',width:'800px'});};return $.get("/all_posts",function(response){return populate_data(response,0);});});}).call(this);(function($){var opts=new Array;var level=new Array;$.fn.jqBarGraph=$.fn.jqbargraph=function(options){init=function(el){opts[el.id]=$.extend({},$.fn.jqBarGraph.defaults,options);$(el).css({'width':opts[el.id].width,'height':opts[el.id].height,'position':'relative','text-align':'center'});doGraph(el);};sum=function(ar){total=0;for(val in ar){total+=ar[val];}
